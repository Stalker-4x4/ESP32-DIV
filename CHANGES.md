...
Версия прошивки на экране увеличивается при каждой перепрошивке: `v1.7.0-1` … текущая **`v1.7.0-15`**
(`ESP32DIV_VERSION` в `shared.h`).

> Раскладка пикселей WS2812 (как физически распаяно, v1.7.0-15): пиксель **0 = CC1101/RFID**,
> пиксели **1/2/3 = nRF24 #1/#2/#3**. Хост-радио (WiFi оранжевый / BT голубой) — на пикселе 1
> (вместе с nRF24 #1). Проба nRF24 на boot-экране переведена на запись/чтение регистра RF_CH.
